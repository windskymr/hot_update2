...
(function(f) {
    try {
        ...
        throw alert("Can't find Moment.js, please read the ion.calendar description."),
            ...
            return this.each(function() {
                ...
                if (!n.data("isActive")) {
                    ...
                    B = function() {
                        ...
                        for (b = 0; 12 > b; b++) a = b === parseInt(d.format("M")) - 1 ? a + ('<option value="' + b + '" selected="selected">' + h.month(b).format("MMMM") + "</option>") : a + ('<option value="' + b + '">' + h.month(b).format("MMMM") + "</option>");
                        a += "</select></div>";
                        ...
                        if (c.sundayFirst) {
                            ...
                            for (b = 1; b <= y; b++) a = moment(d).date(b).format("D.M.YYYY") === t.format("D.M.YYYY") ? a + ('<td class="ic__day ic__day_state_current">' + b + "</td>") : g && moment(d).date(b).format("D.M.YYYY") === g.format("D.M.YYYY") ? a + ('<td class="ic__day ic__day_state_selected">' + b + "</td>") : a + ('<td class="ic__day">' + b + "</td>"),
                            (k + b) / 7 === Math.floor((k + b) / 7) && (a += "</tr><tr>");
                            b = p
                        } else {
                            a += '<table class="ic__week-head"><tr>';
                            for (b = 1; 8 > b; b++) a = 7 > b ? a + ("<td>" + h.day(b).format("dd") + "</td>") : a + ("<td>" + h.day(0).format("dd") + "</td>");
                            a += "</tr></table>";
                            a += '<table class="ic__days"><tr>';
                            k = 0 < k ? k - 1 : 6;
                            for (b = 0; b < k; b++) a += '<td class="ic__day-empty">&nbsp;</td>';
                    ...
                    C = function() {
                        ...
                        x = n.find(".ic__day");
                        c.hideArrows ? (e[0].style.display = "none", l[0].style.display = "none") : (e.on("click",
                        function(a) {
                            a.preventDefault();
                            d.subtract("months", 1);
                        ...
                        function(a) {
                            ...
                            "function" === typeof c.onClick && (c.format ? "moment" === c.format ? c.onClick.call(this, g) : c.onClick.call(this, g.format(c.format)) : c.onClick.call(this, g.format()));
                            s()
                        });
        ...
        init: function(a) {
            ...
            return this.each(function() {
                ...
                if (!a.data("isActive")) {
                    ...
                    t++;
                    this.pluginCount = t;
                    l.lang = a.data("lang") || b.lang; ! 1 === a.data("sundayfirst") && (l.sundayFirst = a.data("sundayfirst"));
                    ...
                    var p = function() {
                        ...
                        var tmpOffset = v + g + 10;
                        var windowWidth = f(window).width();
                        while(tmpOffset + g >= windowWidth - 100){
                        	tmpOffset -= 100;
                        }
                        c.css("left", tmpOffset + "px").css("top", x - 10 + "px"); (h = a.prop("value")) && (h !== d && 0 > b.format.indexOf("L")) && (k = moment(h, b.format), k.isValid() && c.ionCalendar("update", {
                            startDate: h
                        }))
                    }; (function() {
                        u = '<div class="ic__datepicker" id="ic__datepicker-' + z.pluginCount + '"></div>';
                        m.append(u);
                        c = f("#ic__datepicker-" + z.pluginCount);
                        c.ionCalendar(b);
                        c.on("mousedown",
                        function(a) {
                            a.stopPropagation()
